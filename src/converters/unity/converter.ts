...
export const generateFile = (name: string, shader: string) => {
  ...
  const shaderFile = generateShader(name, shader);
...
const generateShader = (name: string, shader: string) => {
...
export const convert = (name: string, shader: string) => {
  generateFile(name, shader);
};
...
const updateTemplate = (text: string) => {
  ...
  const data = {
    ...
    regexMap: {
      ...
      gl_FragCoord: "((i.screenCoord.xy/i.screenCoord.w)*_ScreenParams.xy)",
    },
  };
